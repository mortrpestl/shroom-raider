...
@pytest.fixture
def test_grid() -> Grid:
    """Provide a 5x5 test grid with Player starting at (2,2).

    Returns:
        Grid: A Grid instance with Player initialized.
...
def test_increment_mushroom_count(test_grid: Grid) -> None:
...
def test_kill_sets_is_dead_flag(test_grid: Grid) -> None:
...
def test_get_entity_below_returns_axe_if_present(test_grid: Grid) -> None:
...
def test_get_entity_below_returns_mushroom_if_present(test_grid: Grid) -> None:
...
def test_get_entity_below_returns_water_if_present(test_grid: Grid) -> None:
...
def test_get_entity_below_returns_paved_tile_if_present(test_grid: Grid) -> None:
    """Verify get_entity_below() returns PavedTile if present beneath Player."""
    g = test_grid
    player = g.get_player()
...
def test_get_entity_below_returns_none_when_on_empty_tile(test_grid: Grid) -> None:
    """Verify get_entity_below() returns None when no entity beneath Player."""
    player = test_grid.get_player()
    assert player.get_entity_below() is None


def test_collect_item_adds_to_player_and_removes_from_grid(test_grid: Grid) -> None:
...
def test_collect_item_does_nothing_if_no_item(test_grid: Grid) -> None:
...
def test_get_movement_validity_out_of_bounds(test_grid: Grid) -> None:
...
def test_get_movement_validity_against_tree(test_grid: Grid) -> None:
...
def test_get_movement_validity_with_flamethrower(test_grid: Grid) -> None:
    """Verify Player with Flamethrower burns a Tree in target cell.

    Also verifies:
    - Target cell no longer contains the Tree.
    - Flamethrower is consumed after use.
    """
    g = test_grid
    player = g.get_player()
    tree = ENTITIES["Tree"]([2, 3], g)
...
def test_get_movement_validity_with_axe(test_grid: Grid) -> None:
    """Verify Player with Axe chops a Tree in target cell.

    Also verifies:
    - Target cell no longer contains the Tree.
    - Axe is consumed after use.
    """
    g = test_grid
    player = g.get_player()
